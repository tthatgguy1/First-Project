...
:Colors-Modules
    ...
    set COLOR_BLINKING_BLACK=[6;30m>nul
    set COLOR_BLINKING_BLUE=[6;34m>nul
    set COLOR_BLINKING_CYAN=[6;36m>nul
    set COLOR_BLINKING_GREEN=[6;32m>nul
    set COLOR_BLINKING_PURPLE=[6;35m>nul
    set COLOR_BLINKING_RED=[6;31m>nul
    set COLOR_BLINKING_WHITE=[6;37m>nul
    set COLOR_BLINKING_YELLOW=[6;33m>nul
    set COLOR_BLINKING_BRIGHTBLACK=[1;6;30m>nul
    set COLOR_BLINKING_BRIGHTBLUE=[1;6;34m>nul
    set COLOR_BLINKING_BRIGHTCYAN=[1;6;36m>nul
    set COLOR_BLINKING_BRIGHTGREEN=[1;6;32m>nul
    set COLOR_BLINKING_BRIGHTPURPLE=[1;6;35m>nul
    set COLOR_BLINKING_BRIGHTRED=[1;6;31m>nul
    set COLOR_BLINKING_BRIGHTWHITE=[1;6;37m>nul
    set COLOR_BLINKING_BRIGHTYELLOW=[1;6;33m>nul
